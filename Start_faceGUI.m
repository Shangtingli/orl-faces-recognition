...
global h_axes2;  
global edit2;  
h_f=figure('name','????????????','position',[300,200,600,400]);  
clf reset;  
...
button_open=uicontrol(h_f,'style','push','string','2.Opening photo','position',[250 50 100 50],'callback','GUIopen');  
button_recg=uicontrol(h_f,'style','push','string','1.Training','position',[100 50 100 50],'callback','face');  
button_match=uicontrol(h_f,'style','push','string','3.Matching','position',[400 50 100 50],'callback','GUIrecg'); 